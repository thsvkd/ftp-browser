...
export function LocalBreadcrumb(): React.JSX.Element {
  ...
  if (editing) {
    return (
      <div className="flex items-center border-b border-gray-200 bg-gray-50 px-3 py-1.5">
        <input
          ref={inputRef}
          type="text"
          value={inputValue}
  ...
  return (
    <div
      className="flex items-center gap-0.5 overflow-x-auto border-b border-gray-200 bg-gray-50 px-3 py-1.5 text-sm"
