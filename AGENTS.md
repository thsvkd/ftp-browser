...
- 시크릿은 반드시 .env 또는 시크릿 매니저를 사용한다. 하드코딩 절대 금지.
...
- 문제의 해결을 우회 및 회피를 통해 해결하지 말 것. 최대한 근본적인 원인을 파악하는 노력을 통해 해결할 것.
...
- 카테고리 별로 커밋할 것. 의존성 때문에 묶어서 해야하는 경우 제외.
